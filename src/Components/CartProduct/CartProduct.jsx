            ...
            <div className="row align-items-center">
                ...
                <div className="col-md-8">
                    ...
                    <p className='d-flex justify-content-between'>
                        ...
                        <span className=' p-2 rounded border border-warning'><i className=' fas fa-star rating-color me-1'></i> {cartProduct.product.ratingsAverage}</span>
                    </p>
                    <p><span className='fw-bolder'>Total Price:</span> {cartProduct.price * cartProduct.count} EGP</p>
                </div>
                <div className="col-md-2">
                    <button onClick={() => removeProductFromCart(cartProduct.product._id)} className='btn bg-danger text-white mx-2 mb-2' >Remove</button>
